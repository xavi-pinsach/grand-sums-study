...
module.exports = async function kzg_grandproduct_prover(evalsBufferF, evalsBufferT, pTauFilename, options) {
    ...
    async function computeQPolynomial() {
        ...
        for (let i = 0; i < domainSize; i++) {
            ...
            const identityA = i === 0 ? Fr.sub(z_i, Fr.one) : Fr.zero;
            ...
            identityB = Fr.mul(identityB, challenges.gamma);

            const identities = Fr.add(identityA, identityB);

            evalsBufferQ.set(identities, i_n8);
